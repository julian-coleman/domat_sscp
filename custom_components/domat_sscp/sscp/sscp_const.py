...
# Schedule constants
SCHEDULE_OFF = bytes("\x00\x00", encoding="iso-8859-1")
SCHEDULE_ON = bytes("\x3f\x80", encoding="iso-8859-1")
...
SCHEDULE_EXCEPTIONS_1_START = 0
SCHEDULE_EXCEPTIONS_1_END = 4
SCHEDULE_EXCEPTIONS_2_START = 4
SCHEDULE_EXCEPTIONS_2_END = 8
SCHEDULE_EXCEPTIONS_STATE_START = 8
SCHEDULE_EXCEPTIONS_STATE_END = 10
SCHEDULE_EXCEPTIONS_YEAR_START = 0
SCHEDULE_EXCEPTIONS_YEAR_END = 1
SCHEDULE_EXCEPTIONS_MINS_START = 1
SCHEDULE_EXCEPTIONS_MINS_END = 4

# Exceptions start from 01.01.2000, but after year 0, count from 31.12 of the previous year!
SCHEDULE_EXCEPTIONS_BASE_YEAR = 2000
SCHEDULE_EXCEPTIONS_BASE_MONTH = 1
SCHEDULE_EXCEPTIONS_BASE_DAY = 1
